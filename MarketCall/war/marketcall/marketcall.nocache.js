...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "marketcall" because\n';
  ...
  $wnd.__gwt_activeModules['marketcall'] = {
    'moduleName' : 'marketcall',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/marketcall.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['marketcall'].superdevmode = true;

  var expectedSuffix = '/marketcall.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + marketcall + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:marketcall';
  var devModeSessionKey = '__gwtDevModeSession:marketcall';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/marketcall/marketcall.nocache.js';
  ...
  $wnd.__gwt_activeModules['marketcall'].canRedirect = true;
  $wnd.__gwt_activeModules['marketcall'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/marketcall?user.agent=' + ua + '&_callback=' + callback;
